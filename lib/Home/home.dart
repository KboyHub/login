...
import 'package:login/Components/AddButton.dart';
import 'package:login/Components/ListViewContainer.dart';
import 'package:login/Components/fadeContainer.dart';
import 'package:login/Components/homeTopView.dart';
import 'package:login/Home/homeAnimation.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin{
  ...
  String month = new DateFormat.MMM().format(DateTime.now());
